...
- Before more sections are converted, the homepage needs one shared sticky-table contract so later workers do not each clone their own version of the `Daily Summary` logic.
